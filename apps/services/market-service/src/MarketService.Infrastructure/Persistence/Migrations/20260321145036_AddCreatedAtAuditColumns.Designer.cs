...
namespace MarketService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260321145036_AddCreatedAtAuditColumns")]
            ...
            modelBuilder.Entity("MarketService.Domain.Entities.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "Equity",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsTradable = true,
