...
builder.Services.AddScoped<GetTerminalMarketsHandler>();
builder.Services.AddScoped<GetTerminalWorkspaceHandler>();
builder.Services.AddScoped<PlaceTerminalOrderHandler>();
...
app.MapPetsTerminalEndpoints();
app.MapPetsTerminalOrdersEndpoints();
